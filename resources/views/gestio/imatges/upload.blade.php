...
<form action="{{ route('imatges.upload') }}" enctype="multipart/form-data" method="POST">
    ...
    <button type="submit" id="submit-all" class="btn btn->Pujar</button>
</form>
...
{{-- <form method="post" action="{{ route('imatges.upload') }}" enctype="multipart/form-data">
    ...
    <div class="dropzone" id="dropzone" class="dropzone needsclick dz-clickable">
    ...
    {{-- <button id="sbmtbtn" class="btn btn- type="submit">Pujar</button>
</form> --}}
...
{{-- <input type="file" multiple="multiple" name="image[]" class="dz-hidden-input"
