            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td><input type="number" id="quantitat_mod" name="tentacles" min="1" max="10"
                                value="{{$cistella->quantitat}}" class="form-control" style="width:60px;"></td>
                        <td>{{$cistella->preu * $cistella->quantitat}}€</td>
                        <td>
                            <form action="{{ route('cistella',$cistella->id)}}" method="post"
                                onsubmit="return confirm('Estàs segur de que vols eliminar el producte?');">
                                @csrf
                                @method('DELETE')
            ...
            <table class="table table-responsive">
                <thead>
                    <tr class="thead-light">
                        <th id="producte" style="font-weight: bold;">Producte</th>
                        <th id=fototitol style="font-weight: bold;">Foto</th>
                        <th><span id="quantitattitol" style="margin-left: 148px;font-weight: bold;">Quantitat</span></th>
                        <th><span id="preutitol" style="margin-right: 47px; font-weight: bold;">Preu</span></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span id="imatge"><img class="img-fluid img-thumbnail" src="{{  asset($cistellafoto->fotoaigua) }}" alt="Card image"></span></td>
                        ...
                        <td>
                            <div id="eliminarP">
                                <form id="eliminar" style="margin-left: -48px;"
                                    action="{{ route('cistella',$cistellafoto->id)}}" method="post"
                                    onsubmit="return confirm('Estàs segur de que vols eliminar el producte?');">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="column col-5">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><span style="font-weight: bold;">Cognoms:</span> {{$user->cognom1}}
                        {{$user->cognom2}}</</li> <li class="list-group-item"><span
                            style="font-weight: bold;">Email:</span> {{$user->email}}</</li>
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-left: 150px">
                        ...
                        <div style="font-weight: bold; align-items: center;margin-top: 5px; margin-left: 30px">
                            {{$compteTotal}}€</div>
                        <a href="/compra" style="text-decoration: none;margin-left: 30px"><button type="button"
                                class="btn btn-success">Comprar</button> </a>
                    </div>
                    @endif
                </div>
            </div>
