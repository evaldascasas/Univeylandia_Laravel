...
<style type="text/css">
  ...
  #chatwindow      { border:1px solid #aaaaaa; padding:4px; background:#232D2F; color:white;width:100%;}
  ...
  #info a:hover    { text-decoration:underline; color:#CF9700; }
        ...
        <div id="content" style="display: table;margin: 0 auto;">
            ...
            <input id="chatnick" type="text" size="9" maxlength="10" placeholder="Usuari">&nbsp;
            <input id="chatmsg" type="text" size="94" maxlength="80"  onkeyup="keyup(event.keyCode);" placeholder="Missatge">
...
if(!http_request){alert('Error: no es pot crear una instancia XMLHTTP');return false;}
...
if(!http_request2){alert('Error: no es pot crear una instancia XMLHTTP');return false;}
