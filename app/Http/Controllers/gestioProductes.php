...
class gestioProductes extends Controller
{
    ...
    public function guardarProductePDF()
    {
        ...
        $productes = Producte::join('atributs_producte', 'atributs_producte.id', '=', 'productes.atributs')
            ->join('tipus_producte', 'tipus_producte.id', '=', 'atributs_producte.nom')
            ->orderBy('estat', 'DESC')
            ->orderBy('nom', 'ASC')
            ->get([
                ...
                'tipus_producte.preu_base as preu_base'
            ]);
        ...
        // $pdf = PDF::loadView('/gestio/gestioProductes/pdfProductes', compact('productes', 'reeee', 'tipus_producte', 'tipus_search', 'tipus_producte_seleccionat', 'estat_search'));
        $pdf = PDF::loadView('/gestio/gestioProductes/pdfProductes', compact('productes', 'tipus_producte'));
